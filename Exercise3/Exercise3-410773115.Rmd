...
```{r ans13}
X<-classData$學號[(classData$`公-10-06`=="有看公告"&classData$`練2018-10-17-1`=="1")]
...
```{r ans14}
A<-classData$學號[(classData$`公-10-06`=="沒看公告"&classData$`練2018-10-17-1`=="1")]
B<-classData$學號[(classData$`公-10-06`=="沒看公告")]
C<-length(A)
D<-length(B)
C/D
```
...
```{r ans23}
x<-as.POSIXct (hwData$Timestamp,tz="Asia/Taipei")
y<-as.POSIXct (deadline,tz="Asia/Taipei")
hwData$early<-difftime(y,x,units = "days")
```
